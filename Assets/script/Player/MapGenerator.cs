...
public class MapGenerator : MonoBehaviour
{
    ...
    void SpawnChunk(Vector2 chunkPosition)
    {
        ...
        // lấy chiều cao terrain tại vị trí spawn
        float terrainHeight = Terrain.activeTerrain.SampleHeight(position);

        // cộng thêm vị trí Y của terrain nếu terrain không năm ở y = 0
        position.y = terrainHeight + Terrain.activeTerrain.transform.position.y + 0.5f;
